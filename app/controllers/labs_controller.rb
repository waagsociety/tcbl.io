...
private
  ...
  def lab_params
    params.require(:lab).permit(
	  ...
	  criteria_attributes: [:principle1, :principle2, :principle3, :principle4, :principle5, :principle6, :principle7, :service1, :service2, :service3, :service4, :service5, :skill1, :skill2, :skill3, :skill4, :skill5, :network],
